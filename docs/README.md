...
| 4 | [VPS server setup](04-vps-server-setup.md) | One-time `setup-server.sh` + `add-site.sh` (WireGuard + MediaMTX) |
...
- **Install order for remote:** [04 VPS](04-vps-server-setup.md) → [05 WireGuard on box](05-wireguard-on-box.md) → [02 RTSP relay](02-rtsp-relay.md).
